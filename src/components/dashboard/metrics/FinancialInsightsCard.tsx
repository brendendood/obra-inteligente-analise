...
export const FinancialInsightsCard = ({ financial }: FinancialInsightsCardProps) => {
  ...
  return (
    <Card className="group relative overflow-hidden bg-gradient-to-br from-white via-green-50/30 to-emerald-50/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
