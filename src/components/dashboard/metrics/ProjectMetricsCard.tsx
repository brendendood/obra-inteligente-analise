...
export const ProjectMetricsCard = ({ projectMetrics }: ProjectMetricsCardProps) => {
  ...
  return (
    <Card className="group relative overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-sky-50/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 h-48 sm:h-52">
