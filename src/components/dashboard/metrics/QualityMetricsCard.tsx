    ...
    <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-amber-50">
      <CardHeader>
        <CardTitle className="text-lg font-semibold text-gray-900 flex items-center space-x-2">
          ...
          <InfoTooltip content="Métricas de qualidade e completude dos dados dos projetos" />
        </CardTitle>
      </CardHeader>
      <CardContent>
        {/* Score Geral */}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center p-3 bg-white rounded-lg border border-orange-100">
            <div className={`text-2xl font-bold mb-1 ${getQualityColor(quality.completionRate)}`}>
          ...
          {/* Qualidade dos Dados */}
          <div className="text-center p-3 bg-white rounded-lg border border-orange-100">
            <div className={`text-2xl font-bold mb-1 ${getQualityColor(quality.dataQualityScore)}`}>
          ...
          {/* Taxa de Revisão */}
          <div className="text-center p-3 bg-white rounded-lg border border-orange-100">
            <div className={`text-2xl font-bold mb-1 ${getQualityColor(quality.revisionRate)}`}>
          ...
          {/* Precisão Média */}
          <div className="text-center p-3 bg-white rounded-lg border border-orange-100">
            <div className={`text-2xl font-bold mb-1 ${getQualityColor(quality.avgAccuracy)}`}>
              {quality.avgAccuracy}%
            </div>
            <div className="text-sm text-gray-600 flex items-center justify-center space-x-1">
