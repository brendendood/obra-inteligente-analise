...
const TestimonialCard = ({ testimonial, delay }: { testimonial: Testimonial; delay: string }) => (
  <div className={`animate-testimonial ${delay} flex items-start gap-3 rounded-3xl bg-card/40 dark:bg-zinc-800/40 backdrop-blur-xl border border-white/10 p-5 w-64`}>
    <img src={testimonial.avatarSrc} className="h-10 w-10 object-cover rounded-2xl" alt={`${testimonial.name} avatar`} />
...
export const SignInPage: React.FC<SignInPageProps> = ({
  title = (
    <span className="font-light text-foreground tracking-tighter">
      Bem-vindo à <strong className="font-semibold">MadeAI</strong>
    </span>
  ),
  ...
  return (
    <div className="h-[100dvh] w-[100dvw] flex flex-col md:flex-row font-sans bg-background text-foreground">
      ...
      {/* Coluna direita: imagem + depoimentos (opcional) */}
      {heroImageSrc && (
