  ...
  ({ className, onComplete, ...props }, ref) => {
    ...
    return (
      <motion.div
        ...
        className={cn(
          "shadow-button-inset dark:shadow-button-inset-dark relative flex h-9 items-center justify-center rounded-full bg-muted",
        ...
        <AnimatePresence key={crypto.randomUUID()}>
          {!completed && (
            <motion.div
              ...
              style={{ x: springX }}
              className={cn(
                "absolute -left-4 z-10 flex items-center justify-start",
            ...
            >
              <Button
                ...
                className={cn(
                  ...
                  isDragging && !props.disabled && "scale-105 transition-transform",
                  className
                )}
              >
