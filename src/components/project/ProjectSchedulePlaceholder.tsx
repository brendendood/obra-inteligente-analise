...
export const ProjectSchedulePlaceholder = () => {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-indigo-700 text-sm">
                Cronograma específico para este projeto
              </p>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2 text-indigo-800">
              ...
              <span className="text-sm">
                Processando cronograma do projeto...
              </span>
            </div>
            ...
            {currentProject.analysis_data ? (
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <p className="text-yellow-800 text-sm">
                  ⏳ Aguardando análise do projeto para gerar cronograma específico
                </p>
              </div>
            )}
          </div>
