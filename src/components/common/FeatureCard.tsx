...
const FeatureCard = ({ 
  ...
  return (
    <Card 
      className={`hover:shadow-xl transition-all duration-300 cursor-pointer group border-0 shadow-lg bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm h-full dark:border-slate-600 ${
