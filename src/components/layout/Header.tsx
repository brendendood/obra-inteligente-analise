...
const Header = () => {
  ...
  return (
    <header className="fixed top-4 left-4 right-4 z-50 transition-all duration-300 theme-transition bg-white dark:bg-black supports-[backdrop-filter]:bg-white/80 supports-[backdrop-filter]:backdrop-blur-md dark:supports-[backdrop-filter]:bg-black/80 border border-black/10 dark:border-white/10 rounded-2xl">
