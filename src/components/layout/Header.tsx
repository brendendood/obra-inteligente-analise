...
const Header = () => {
  ...
  return (
    <header className="fixed top-4 left-4 right-4 z-50 transition-colors duration-300 bg-white/70 supports-[backdrop-filter]:backdrop-blur-md shadow-none border border-black/5 dark:bg-[#000000] dark:shadow-none dark:border-white/10 rounded-2xl">
