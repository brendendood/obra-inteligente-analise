-- Corrigir o trigger de criação automática de perfil (usando o plano correto)
...
BEGIN
  ...
  -- Inserir assinatura free como padrão (usando o valor correto do enum)
  INSERT INTO public.user_subscriptions (user_id, plan, status)
  VALUES (NEW.id, 'basic'::subscription_plan, 'active'::subscription_status);
...
SELECT 
  au.id,
  'basic'::subscription_plan as plan,
