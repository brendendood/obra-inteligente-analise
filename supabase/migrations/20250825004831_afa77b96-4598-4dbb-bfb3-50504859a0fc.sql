...
-- Only superusers and authenticated admin users can view admin user data
...
INSERT INTO public.admin_security_logs (
    ...
    jsonb_build_object(
        'table', 'admin_users',
        'action', 'fixed_insecure_rls_policy',
        'previous_policy', 'email matching vulnerability',
        'new_policy', 'superuser_only_access'
    ),
    true
