-- Criar trigger para disparar emails automaticamente quando novo usuário se cadastra
CREATE OR REPLACE TRIGGER on_auth_user_created
  AFTER INSERT ON auth.users
  FOR EACH ROW
  EXECUTE FUNCTION public.handle_new_user_profile();

-- Atualizar a função handle_new_user_profile para incluir disparo de emails imediato
